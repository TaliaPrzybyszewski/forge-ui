...
const RENDERERS: Record<string, React.ComponentType<{ props: any }>> = {
...
export default function RendererDispatch() {
  ...
  if (!Renderer) return <div style={{ color: 'var(--hint)', fontSize: 12 }}>No renderer for {activeComponent}</div>
